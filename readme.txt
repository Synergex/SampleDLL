SampleDLL - Examples of DLL routines that return pointers

Chip Camden	November, 2009

This code sample demonstrates three different use cases for returning values
from a DLL routine:

1.  Returning a simple integer value
2.  Returning a pointer to a data structure
3.  Returning a pointer to a pointer to a data structure
